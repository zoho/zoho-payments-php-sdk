...
final class MandateEnrollmentSessionCreateParams
{
    private const TYPE = 'mandate_enrollment';
    ...
    public function __construct(
        ...
        public readonly MandateDetailsParams $mandateDetails,
        public readonly ?string $invoiceNumber = null,
        public readonly ?int $maxRetryCount = null,
        ?array $metaData = null,
        public readonly ?MandateConfigurationsParams $configurations = null,
    ) {
    ...
    public function toArray(): array
    {
        return [
            ...
            'mandate_details' => $this->mandateDetails->toArray(),
